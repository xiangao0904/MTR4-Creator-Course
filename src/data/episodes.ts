...
export const episodes: Episode[] = [
  {
    ...
    summary: '介绍 MTR 4.0 的资源包生态、课程范围、学习路线和最终目标，先建立完整认知。',
    output: '明确学习路线，准备后续开发环境',
    guestRole: '导论 / 规划 / 入门',
    tags: ['导论', '路线图', '课程说明'],
    topics: ['课程结构说明', '资源包与附加内容的关系', '后续章节安排', '学习前需要准备什么'],
  },
  {
    id: 'ep1',
    number: 'EP1',
    ...
    summary: '完成目录创建、pack.mcmeta、pack.png 和基础 assets 结构，建立第一套可识别工程。',
    output: '一个可被 MTR 4.0 识别的空白资源包',
    guestRole: '基础 / 结构 / 环境',
    tags: ['资源包', 'pack.mcmeta', '目录结构'],
    topics: ['创建资源包文件夹', '编写 pack.mcmeta', '准备 pack.png', '检查游戏是否正常识别'],
  },
  {
    id: 'ep2',
    number: 'EP2',
  ...
  },
  {
    ...
    guestRole: '贴图 / 美术 / 视觉',
    tags: ['贴图', '涂装', '视觉设计'],
    topics: ['贴图尺寸与格式', '透明区域处理', '车门车窗与标识', '风格统一与版权意识'],
  },
  {
    id: 'ep4',
    number: 'EP4',
  ...
  },
  {
    ...
    summary: '继续完善车头、车门、车窗、车顶和转向架等关键结构，控制比例和面数。',
